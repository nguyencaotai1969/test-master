		...
		<div id="above_footer">
			<h1 style="text-align: center;color: #fff;padding-top: 10px; font-size: 100%">Chọn DPV, chọn sự Uy Tín, nhanh gọn và đảm bảo</h1>
			<h3 style="text-align: center;color: #85afdb;font-size: 100%">Travel Agency đem đến cho bạn những trải nghiệm tuyệt vời nhất!</h3>
		</div>
